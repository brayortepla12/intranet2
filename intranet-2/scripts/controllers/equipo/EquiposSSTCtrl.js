app.controller('EquiposSSTCtrl', ["$scope", "$rootScope", "HojaVidaSSTService", "ServicioService", "SedeService", "EmpresaService", "EncabezadoService", "FrecuenciaService",
    "$filter",
    function ($scope, $rootScope, HojaVidaSSTService, ServicioService, SedeService, EmpresaService, EncabezadoService, FrecuenciaService, $filter) {
        ...
        $scope.BuscarHojaVidas = function () {
            if ($scope.SedeId !== "--") {
                $scope.cargado = false;
                HojaVidaSSTService.GetHojaVidaSedeId($scope.SedeId, $scope.ServicioId, $scope.Estado).then(function (d) {
                    console.log(d.data);
                    $scope.simpleTableOptions = {
                        data: [],
                        aoColumns: [
        ...
        $scope.ViewItem = function (i) {
            HojaVidaSSTService.GetHojaVidaHojaVidaId($scope.simpleTableOptions.data[i].HojaVidaId).then(function (d) {
