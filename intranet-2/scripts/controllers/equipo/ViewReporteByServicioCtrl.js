app.controller('ViewReporteByServicioCtrl', ["$scope", "$stateParams", 'ReporteService', 'SesionService', 'EncabezadoService', 'EmpresaService',
    function ($scope, $stateParams, ReporteService, SesionService, EncabezadoService, EmpresaService) {
        ...
        function GetReporteByServicioId(obj) {
            ReporteService.GetReporteByServicioId(obj).then(function (d) {
                console.log(d.data)
