app.controller('ReporteEscaneadoCtrl', ["$scope", "$rootScope", "ServicioService", "SedeService", "ReporteService", "SesionService", "$filter", "HojaVidaService", "UsuarioService",
            ...
            if (!$scope.Datos.$valid) {
                ...
                ReporteService.PostReporteEscaneado($scope.Archivo, $scope.reporte_escaneado).then(function (d) {
                    if (typeof d.data != "string") {
                        ...
                        $scope.reporte_escaneado.EstadoFinal = JSON.parse($scope.reporte_escaneado.EstadoFinal);
//                        $scope.Reset();
                    } else {
...
//            $scope.reporte_escaneado.ServicioId = "--";
        ...
        $scope.ChangeServicio = function () {
            HojaVidaService.GetHojaVida($scope.reporte_escaneado.ServicioId).then(function (d) {
                $scope.Equipos = $filter("orderBy")(d.data, "Ubicacion");;
            }, function (e) {
                swal("Error", e, "error");
            });
            $scope.ResetParcial();
