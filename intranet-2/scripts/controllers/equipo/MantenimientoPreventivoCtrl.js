app.controller('MantenimientoPreventivoCtrl', ["$scope", "ServicioService", "MantenimientoPreventivoService", "$rootScope", "$filter", "EmpresaService", "EncabezadoService",
    function ($scope, ServicioService, MantenimientoPreventivoService, $rootScope, $filter, EmpresaService, EncabezadoService) {
...
//            }
            ...
            $scope.Sede = $scope.Servicios[$scope.ServicioId].NombreSede;
        };
        //</editor-fold>
        ...
        function GetListados() {
            if ($scope.ServiciosSeleccionados.length !== 0) {
                ...
                MantenimientoPreventivoService.GetAllByServicios(obj).then(function (c) {
                    console.log(c.data)
