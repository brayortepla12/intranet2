app.controller('TransporteMaternaCtrl', ["$scope", "$rootScope", "TmEventoService", "MaternaService", "DepartamentoService", "MunicipioService", "TarifaService",
    ...
    function ($scope, $rootScope, TmEventoService, MaternaService, DepartamentoService, MunicipioService, TarifaService, EmpresaService, EncabezadoService) {
        ...
        $scope.GuardarEvento = function () {
            if(!$scope.CargandoBandera){
                ...
                } else if ($scope.Evento.Detalles.length === 0 && $scope.Evento.TipoEvento == "Parto") {
        ...
        function GetEventos() {
            $scope.cargado = false;
            TmEventoService.getEventos($scope.TipoEvento).then(function (c) {
                $scope.Eventos = c.data;
        ...
        function SetFormat(lst) {
            ...
            for (var i in lst) {
                ...
                if(lst[i].Estado == 'Activo' && $scope.TipoEvento == "Solicitado"){ //  && fechaHoy == lst[i].FechaRegistro.split(" ")[0]
