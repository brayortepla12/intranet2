'use strict';
app.controller('AuditoriaSesion', ["$scope", "SesionService", "$rootScope", "$state", "UsuarioService", 
    function ($scope, SesionService, $rootScope, $state, UsuarioService) {
        var currentState = $state.current.name;
        $rootScope.navegacion = currentState;
