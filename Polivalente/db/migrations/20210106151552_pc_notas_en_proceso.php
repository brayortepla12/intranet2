...
class PcNotasEnProceso extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $this->execute("INSERT INTO `polivalente`.`permiso` (`Tipo`, `State`, `label`, `ModuloId`) VALUES ('ver vista', 'pc.auditoria', 'AUDITAR PROCESOS', '8');");
        $this->execute("DROP FUNCTION IF EXISTS `polivalente`.`PC_GetEventoSolByProcesoId`;
        DELIMITER $$
