...
class DB
{
     ...
     *
     * @return DB Returns the current instance.
     */
     ...
     *
     * @return array|DB Contains the returned rows from the select query.
     * @throws Exception
     */
     ...
     *
     * @uses $DB->orderBy('id', 'desc')->orderBy('name', 'desc', '^[a-z]')->orderBy('name', 'desc');
     *
    ...
    /**
     * Method returns a copy of a DB subquery object
     *
     * @return DB new DB object
     */
    ...
    /**
     * Get where and what function was called for query stored in DB->trace
     *
