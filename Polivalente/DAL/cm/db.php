...
//                        $answer->nombre = strtoupper($answer->nombre);
//                        str_replace("Ñ", "--", $answer->nombre);                        
                    $response[] = $answer;
                }
            } else {
...
//    public function GetCondutores($query, $format = 'object') {
//        $usuario= 'sa';
//$pass = 'menamedina';
//$servidor = '192.168.9.116';//WIN-34J97EOMQVN
...
//        $response = array();
//        while ($answer = sqlsrv_fetch_array($resultado,SQLSRV_FETCH_ASSOC)) {
//            array_push($response, $answer);
////                    echo json_encode($answer);
//        }
//        return $response;
