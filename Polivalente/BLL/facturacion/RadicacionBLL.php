 ...
 */
require_once dirname(__FILE__) . '/../../DAL/facturacion/RadicacionDAL.php';

class RadicacionBLL {

    public function GetRadicacion($Mes, $Anno) {
        $Helper = new RadicacionDAL();
        $obj = new stdClass();
        $obj->Radicacion = $Helper->GetRadicacion($Mes, $Anno);
        $obj->TotalRadicacion = $Helper->GetTotalRadicacion($Mes, $Anno);
        return $obj;
    }
