select h.HojaVidaId, h.Nombre as Equipo, h.Ubicacion, h.FrecuenciaMantenimientoId, f.Nombre as Frecuencia, s.Nombre as Servicio, s.ServicioId, 
...
inner join sede as sed on sed.SedeId = 1
inner join sistemas_hojavida as h on h.ServicioId = s.ServicioId
inner join frecuenciamantenimiento as f on h.FrecuenciaMantenimientoId
where c.Vigencia = 2019  and (('Todos' = '$Todos') or s.ServicioId = '20') group by s.ServicioId, h.HojaVidaId order by s.Nombre, h.Nombre